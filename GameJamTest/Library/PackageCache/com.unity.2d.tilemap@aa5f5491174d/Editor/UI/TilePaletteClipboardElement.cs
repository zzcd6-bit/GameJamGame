    ...
    public partial class TilePaletteClipboardElement : VisualElement
    {
        ...
        private void AttachToPanel()
        {
            if (m_TilePaletteClipboard == null)
            {
                ...
                m_TilePaletteClipboard.clipboardParentSource = ClassListContains(overlayClassName) ? GridPaintPaletteClipboard.ClipboardParentSource.Overlay : GridPaintPaletteClipboard.ClipboardParentSource.Window;
                m_TilePaletteClipboard.SetupPreviewCameraOnInit();
        ...
        private void OnWheelEvent(WheelEvent evt)
        {
            ...
            m_TilePaletteClipboard.HandleWheelEvent(evt.delta, evt.localMousePosition, evt.shiftKey);
            evt.StopPropagation();
            HandleRepaint();
        }
